...
const SaleOrder = () => {
  ...
  const [currentFilter, setCurrentFilter] = useState({ code: '', price: '', quantity: '', total: '', status: '', items__product_id: '', store_id: '', balance_id: '', customer_id: '', items__price: '', items__quantity: '', items__total: '' });
