...
const InternalServerError = ({ title, description }) => {
            ...
            >
                <Grid item xs={10} style={{ textAlign: 'center' }}>
                    <div>
                        ...
                        <Button
                            className="btn-danger px-5 font-size-sm font-weight-bold btn-animated-icon text-uppercase rounded shadow-sm-dark py-3 hover-scale-sm hover-scale-lg btn-pill mt-4 mx-4"
                            onClick={handleRetry}
                        >
